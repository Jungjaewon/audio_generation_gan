...
# Reference1 : http://blog.naver.com/PostView.nhn?blogId=honeycomb-tech&logNo=221632925662&categoryNo=11&parentCategoryNo=0&viewDate=&currentPage=1&postListTopCurrentPage=1&from=postView
...
def main(config):
    ...
    solver = Solver(config, get_loader(config, 'train'))
